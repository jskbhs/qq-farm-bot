...
module.exports = {
    ...
    getFriendGuardDogGids: accountConfig.getFriendGuardDogGids,
    setFriendGuardDogGids: accountConfig.setFriendGuardDogGids,
    addFriendGuardDogGid: accountConfig.addFriendGuardDogGid,
    removeFriendGuardDogGid: accountConfig.removeFriendGuardDogGid,
