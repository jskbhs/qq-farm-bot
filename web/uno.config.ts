...
export default defineConfig({
  shortcuts: {
    ...
    'farm-card': 'rounded-2xl bg-white/25 dark:bg-gray-900/25 backdrop-blur-xl border border-white/30 dark:border-white/10 shadow-lg shadow-black/5 p-4 transition-all duration-250 hover:-translate-y-0.5',
    'farm-panel': 'rounded-2xl bg-white/30 dark:bg-gray-900/30 backdrop-blur-xl border border-white/40 dark:border-white/15 shadow-lg shadow-black/5 p-5 transition-all duration-250 hover:-translate-y-0.5',
